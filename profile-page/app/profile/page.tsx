...
import { Edit, GraduationCap, Mail, MapPin, Moon, Phone, Sun, Briefcase, Plus, Trash2 } from "lucide-react"
...
export default function ProfilePage() {
  ...
  return (
    <div
      className={`min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-900 dark:to-gray-800 py-8 transition-colors duration-300 ${darkMode ? "dark" : ""}`}
    >
                  ...
                  {experience.map((job, index) => (
                    <div key={index} className="flex">
                      <div className="flex flex-col items-center mr-4">
                        <div
                          className={`flex items-center justify-center w-10 h-10 rounded-full border-2 ${index === 0 ? "border-primary" : "border-muted"}`}
                        >
