...
import { BentoGrid, BentoGridItem } from "@/components/ui/bento-grid-components";
import {
...
const BentoGridThirdInterface=()=> {
  return (
    ...
    <BentoGrid className="max-w-7xl my-20 mx-auto md:auto-rows-[20rem] max-sm:flex flex-col">
      {items.map((item, i) => (
        <BentoGridItem
        key={i}
        title={item.title}
...
export default BentoGridThirdInterface