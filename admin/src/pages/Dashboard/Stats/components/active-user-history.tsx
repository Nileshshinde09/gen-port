...
const ActiveUserHistory = () => {
  ...
  React.useEffect(() => {
    if (timeRange === "30d") {
      ...
      setDuration(90); // Default to 90 days if no specific range is set
    }
  ...
  return (
    <Card>
      <CardHeader className="flex items-center gap-2 space-y-0 border-b py-5 sm:flex-row">
        ...
        <div className="">
          <InfoDialog>
            <Card className="rounded-lg p-1 cursor-pointer hover:scale-105 transition-all">
              <Info className="" />
            </Card>
          </InfoDialog>
        </div>
...
export default ActiveUserHistory;
